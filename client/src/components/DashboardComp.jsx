  ...
  return (
    <div className='p-3 md:mx-auto'>
      <div className='flex-wrap flex gap-4 justify-center'>
        <div className='flex flex-col p-3 dark:bg-slate-800 gap-4 md:w-72 w-full rounded-md shadow-md'>
          <div className='flex justify-between'>
            <div className=''>
              <h3 className='text-gray-500 text-md uppercase'>Approved Posts</h3>
              <p className='text-2xl'>{posts.filter((post) => post.approved === true).length}</p>
            </div>
      ...
      <div className='flex flex-wrap gap-4 py-3 mx-auto justify-center'>
        {currentUser === "admin" && <div className='flex flex-col w-full md:w-auto shadow-md p-2 rounded-md dark:bg-gray-800'>
